...
{
    /// <summary>
    /// Editor graph node representing move action node within the behavior tree editor.
    /// </summary>
    public class MoveActionGraphNode : BehaviourTreeGraphNode
    {
        public override RuntimeGraphNode ToRuntimeGraphNode()
        {
            ...
            return new RuntimeMoveActionGraphNode(unitVariableValue, gridControllerVariableValue, evaluators);
        }
