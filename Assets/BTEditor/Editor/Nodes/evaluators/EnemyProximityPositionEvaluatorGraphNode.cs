...
{
    /// <summary>
    /// Editor graph node representing a <see cref="EnemyProximityPositionEvaluator"/>.
    /// </summary>
    public class EnemyProximityPositionEvaluatorGraphNode : PositionEvaluatorGraphNode
    {
        public override RuntimePositionEvaluatorGraphNode ToRuntimeGraphNode()
        {
            ...
            return new RuntimeEnemyProximityPositionEvaluatorGraphNode(weightVariableValue);
        }
    }
}