...
{
    /// <summary>
    /// Editor graph node representing a <see cref="RandomPositionEvaluator"/>.
    /// </summary>
    public class RandomPositionEvaluatorGraphNode : PositionEvaluatorGraphNode
    {
        public override RuntimePositionEvaluatorGraphNode ToRuntimeGraphNode()
        {
            ...
            return new RuntimeRandomPositionEvaluatorGraphNode(weightVariableValue);
        }
    }
}