...
{
    /// <summary>
    /// Editor graph node representing an inverter node within the behavior tree editor.
    /// </summary>
    public class InverterGraphNode : BehaviourTreeGraphNode
    {
        public override RuntimeGraphNode ToRuntimeGraphNode()
        {
            ...
            return new RuntimeInverterGraphNode(childNode);
        }
