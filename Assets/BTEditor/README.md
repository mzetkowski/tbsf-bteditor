...
A visual editor for creating behaviour trees for the Turn Based Strategy Framework in Unity.
...
1. Install the Graph Toolkit, as described here:  
   [Graph Toolkit Installation Guide](https://docs.unity3d.com/Packages/com.unity.graphtoolkit@0.4/manual/installation.html)
...
3. Assign the `BTEditor/RegularBehaviourTreeProfile` to the **Profile** field in the `BehaviourTreeProfileAdapter` component.  
...
2. Add and connect nodes to define behaviour logic.  
   > [!NOTE]  
   > Each graph must start with a `RootGraphNode`.
3. Save the graph.
...
To contribute to the development of the Behavior Tree Editor:
